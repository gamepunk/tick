...
from tick.core.models import Symbol, AssetType
from tick.datasources.base import DataSourceRegistry, BaseDataSource
from tick.datasources import yfinance_ds, akshare_ds, ccxt_ds  # 确保数据源被注册
    ...
    def detect_market(cls, symbol: Symbol) -> str:
        ...
        if asset == AssetType.FUTURES:
            ...
            if s in ("AU", "AG", "CU", "RB", "HC") or (
                any(s.startswith(p) for p in ("AU", "AG", "CU", "AL", "RB", "HC", "SC", "NI", "ZN", "PB"))
